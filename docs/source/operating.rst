[iotsolution-restapi-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [iotsolution-restapi-3f10] container is NOT running**.

.. tip::
   You must have your [iotsolution-restapi-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   maadsdocker/iotsolution-restapi-3f10-amd64 (https://hub.docker.com/r/maadsdocker/iotsolution-restapi-3f10-amd64)
...
.. code-block::
   ...
   docker run -d -p 37127:37127 -p 53833:53833 -p 40847:40847 -p 9002:9002 \
          --env TSS=0 \
          --env SOLUTIONNAME=iotsolution-restapi-3f10 \
          --env SOLUTIONDAG=solution_preprocessing_dag_restapi-iotsolution-restapi-3f10 \
          --env GITUSERNAME=smaurice101 \
          --env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \
          --env SOLUTIONEXTERNALPORT=37127 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=53833  \
          --env SOLUTIONVIPERVIZPORT=40847 \
          ...
          maadsdocker/iotsolution-restapi-3f10-amd64
...
It can be accessed by entering: http://localhost:53833
...
.. important::
   http://localhost:40847/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:40847/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:40847/<html file>
...
[iotsolution-restapi-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/iotsolution-restapi-3f10
...
.. important::
   https://iotsolution-restapi-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag_restapi-iotsolution-restapi-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=37127, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44031, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41567, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35615, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33977, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41877, HPDEHOST=127.0.1.1, HPDEPORT=38525, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33473

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8604-iotsolution-restapi-3f10,solution_preprocessing_dag_restapi-iotsolution-restapi-3f10, python-preprocess-9672-iotsolution-restapi-3f10,solution_preprocessing_dag_restapi-iotsolution-restapi-3f10, python-preprocess2-8162-iotsolution-restapi-3f10,solution_preprocessing_dag_restapi-iotsolution-restapi-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
